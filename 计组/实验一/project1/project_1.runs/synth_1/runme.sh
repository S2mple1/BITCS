...
HD_PWD='D:/下载/Principles-of-computer-composition-ALU-main/Principles-of-computer-composition-ALU-main/实验一/project1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mine.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mine.tcl
